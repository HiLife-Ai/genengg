<?php $this->load->view('admin/menu');?>
    ...
    <section class="home-section">
        ...
        <form name="createEmployee" action="<?php echo base_url().'index.php/employee/edit/'.$employee['id']?>" method="post">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="empAdd" id="empAdd" value="<?php echo set_value('empAdd',$employee['empAdd']);?>" rows="5" style="width: 635%;"></textarea>
                    </div>
                </div>
            </div>
            <div class="row table-4">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="empSkill" id="empSkill" value="<?php echo set_value('empSkill',$employee['empSkill']);?>" rows="1" style="width: 635%;"></textarea>
                    </div>
                </div>
            </div>
            <div class="row table-2">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="remark" id="remark" value="<?php echo set_value('remark',$employee['remark']);?>" rows="5" style="width: 635%;"></textarea>
                    </div>
                </div>
            </div>
            <div class="row table-6">
                <div class="save-btn">
                    ...
                    <a href="<?php echo base_url().'index.php/employee/gm_index'?>" class="btn-secondary btn">Cancel</a>
                </div>
            </div>
        </form>
    </section>