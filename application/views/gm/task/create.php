...
$query = "select taskId from task order by taskId desc";
...
<section class="home-section">
        ...
        <div class="line"></div> -->
        <form name="createTask" action="<?php echo base_url().'index.php/task/gm_create'?>" method="post">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="taskDesc" id="taskDesc" value="" rows="5" style="width: 635%;"></textarea>
                    </div>
                </div>
            </div>
