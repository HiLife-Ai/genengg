...
<section class="home-section">
        ...
        <div class="line"></div> -->
        <form name="createTask" action="<?php echo base_url().'index.php/task/gm_edit/'.$task['taskId']?>" method="post">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="taskDesc" id="taskDesc" value="" rows="5" style="width: 400%;"><?php echo set_value('taskDesc',$task['taskDesc'])?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row table-4">
                <div class="col-md-12">
                    ...
                    <?php $prpMemarr=explode(",",$task['taskMem']); ?>
                        ...
                        <select name="taskMem[]" id="user_id" placeholder="Choose Members" class="form-control" value="" multiple >
...
?>
            ...
            <div class="row table-6">
                ...
                <a href="<?php echo base_url().'index.php/task/gm_index'?>" class="btn-secondary btn">Cancel</a>
                </div>
            </div>
        </form>
    </section>
