...
<section class="home-section">
        ...
        <div class="line"></div>
        <form name="createClient" action="<?php echo base_url().'index.php/client/gm_create'?>" method="post">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="clnAdd" id="clnAdd" value="" rows="5" style="width: 635%;"></textarea>
                    </div>
                </div>
            </div>
