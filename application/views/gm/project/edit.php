...
<section class="home-section">
        ...
        <div class="line"></div>
        <form name="createProject" action="<?php echo base_url().'index.php/project/gm_edit/'.$id?>" method="post">
            ...
            <div class="row table-2">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="proMem[]" id="project_mem" placeholder="Choose Members" class="form-control" value="" multiple >
                            <option value="">--</option>
