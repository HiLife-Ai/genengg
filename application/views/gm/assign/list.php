<?php $this->load->view('gm/menu');?>
    ...
    <section class="home-section">
        ...
        <div class="col-6" id="add-emp">
            <a href="<?php echo base_url().'index.php/assign/gm_create'?>" class="btn btn-outline-primary">New Task Assign</a>
                    ...
                    <tbody>
                        <?php if(count($assigned)>0) { foreach($assigned as $assign) {?>
                            <tr>
                                ...
                                <td>
                                    <!-- <a href="<?php echo base_url().'index.php/assign/gm_edit/'.$assign['id']?>" class="btn btn-outline-primary">Edit</a> -->
                                    <a onclick="confirm('Are you sure want to delete?')" href="<?php echo base_url().'index.php/assign/gm_delete/'.$assign['id']?>" class="btn btn-outline-danger">Delete</a>
                                </td>
                            </tr>
                            <?php } } else { ?>
                                <tr>
