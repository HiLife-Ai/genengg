...
<?php $this->load->view('hm/menu');?>
    <section class="home-section">
        ...
        <form name="createEmployee" action="<?php echo base_url().'index.php/employee/hr_create'?>" method="post">
            <div class="row table-1">
                <div class="col-md-3">
                    <label class="form-label" for="form-label">Employee ID</label>
                    <input class="form-control" type="text" name="empId" id="empId" value="<?php echo $empId?>" readonly>
                </div>
                <div class="col-md-3">
            ...
            <div class="row table-2">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="empGender" id="empGender" style="height:50%;">
                        <option value="">--</option>
                        <?php
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="empAdd" id="empAdd" value="" rows="5" cols="300"></textarea>
                    </div>
                </div>
            </div>
            <div class="row table-4">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="empSkill" id="empSkill" value="" rows="1" cols="300"></textarea>
                    </div>
                </div>
            </div>
            <div class="row table-2">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="remark" id="remark" value="" rows="5" cols="300"></textarea>
                    </div>
                </div>
            </div>
