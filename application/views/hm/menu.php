...
<div class="sidebar">
    <div class="logo-details">
        ...
        <div class="logo_name">HR Manager</div>
    ...
    <ul class="nav-list">
        ...
        <li class="sidebar-dropdown" id="sidebar-dropdown1">
            <a href="<?php echo base_url().'index.php/hm_dashboard'?>" ><i class='bx bx-grid-alt'></i>
        ...
        <li class="sidebar-dropdown" id="sidebar-dropdown2">
            ...
            <div class="sidebar-submenu" id="sidebar-submenu2">
                <ul>
                    <li><a href="<?php echo base_url().'index.php/employee/hr_index'?>">Employee List</a></li>
                    <li><a href="<?php echo base_url().'index.php/project/hm_index'?>">project List</a></li>
                    
                    <li><a href="<?php echo base_url().'index.php/task'?>">Task List</a></li>
