                    ...
                    <tbody>
                        ...
                        if(count($employees)>0) { foreach($employees as $employee) {?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url().'index.php/employee/edit/'.$employee['empId']?>" class="btn btn-outline-primary">Edit</a>
                                    <a onclick="confirm('Are you sure want to delete?')" href="<?php echo base_url().'index.php/employee/delete/'.$employee['empId']?>" class="btn btn-outline-danger">Delete</a>
                                </td>
                            </tr>
                            <?php } } else { ?>
                                <tr>
