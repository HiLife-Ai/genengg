<?php $this->load->view('admin/menu');?>
    ...
    <section class="home-section">
        ...
        <form name="createEmployee" action="<?php echo base_url().'index.php/employee/edit/'.$employee['empId']?>" method="post">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" name="empRole" id="empRole" style="height: 50%;">
                        ...
                        <?php if (count($getRole)):?>
                            ...
                            <?php 
$x="";                            
                            if($employee['empRole'] == $role->role){
                            
$x="selected";                            
                                
                            }
                            ?>  
                            <option <?php echo $x; ?> value="<?php echo $role->role;?>"><?php echo $role->role;?></option>
                            <?php endforeach;?>
                        <?php else:?>
                        <?php endif?>
                    </select>
