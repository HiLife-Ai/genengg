...
<section class="home-section">
        ...
        <div class="line"></div>
        <form name="createClient" action="<?php echo base_url().'index.php/client/edit/'.$client['clnId']?>" method="post">
            ...
            <div class="row table-3">
                <div class="form-group address">
                    ...
                    <div class="col-md-12">
                        <textarea class="form-control" name="clnAdd" id="clnAdd" rows="5" cols="300"><?php echo set_value('clnAdd',$client['clnAdd'])?></textarea>
                    </div>
                </div>
            </div>
