<?php $this->load->view('pm/menu');?>
    ...
    <section class="home-section">
        ...
        <div class="col-6" id="add-emp">
            <a href="<?php echo base_url().'index.php/task/pm_create'?>" class="btn btn-outline-primary">Add New Task</a>
                    ...
                    <tbody>
                        ...
                        if(count($tasks)>0) { foreach($tasks as $task) {?>
                            <tr>
                                ...
                                ?>    </td>
                                <td>
                                    <a href="<?php echo base_url().'index.php/task/pm_edit/'.$task['taskId']?>" class="btn btn-outline-primary">Edit</a>
                                    <a onclick="confirm('Are you sure want to delete?')" href="<?php echo base_url().'index.php/task/pm_delete/'.$task['taskId']?>" class="btn btn-outline-danger">Delete</a>
                                </td>
                            </tr>
                            <?php } } else { ?>
                                <tr>
