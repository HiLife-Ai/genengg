...
<div class="sidebar">
    <div class="logo-details">
        ...
        <div class="logo_name">Project Manager</div>
    ...
    <ul class="nav-list">
        ...
        <li class="sidebar-dropdown" id="sidebar-dropdown1">
            <a href="<?php echo base_url().'index.php/pm_dashboard'?>" ><i class='bx bx-grid-alt'></i>
        ...
        <li class="sidebar-dropdown" id="sidebar-dropdown3">
            ...
            <div class="sidebar-submenu" id="sidebar-submenu3">
                <ul>
                    ...
                    <!-- <li><a href="<?php echo base_url().'index.php/assign/index'?>">Assign Task</a></li> -->
                </ul>
            </div>
        </li>
