...
<section class="home-section">
        ...
        <div class="add-text">Edit PROJECT INFO</div>
        <div class="add-text-dtls">PROJECT DETAILS</div>
        <div class="line"></div>
        <form name="createProject" action="<?php echo base_url().'index.php/project/pm_edit/'.$id?>" method="post">
            ...
            <div class="row table-2">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="proMem[]" id="user_id" placeholder="Choose Members" class="js-example-basic-single"  multiple="true" >
                            <option value="">--</option>
